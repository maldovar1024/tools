...
type RadixConverterShowerProp = (
  | { inputMode: true; autoFocus?: boolean; onInputChange: (input: string) => void }
  | { inputMode: false }
) &
...
const RadixConverterShower = forwardRef<Input, RadixConverterShowerProp>((props, ref) => (
  <div className={props.className}>
    ...
    {props.inputMode ? (
      ...
      <Input ref={ref} value={props.value} addonBefore={props.addonBefore} readOnly />
    )}
  </div>
));
